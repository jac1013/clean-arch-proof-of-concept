...
public class ReservationController {
    ...
    That's the reason bookFlight in the reservator has that long signature, it just because of the simplicity of the
    proof of concept.
     */
    public Optional<Reservation> bookFlight() {
        return Optional.ofNullable(reservator.bookFlight(null, null, response.getPassenger(), response.getFrom(), response.getTo()));
    }
}
